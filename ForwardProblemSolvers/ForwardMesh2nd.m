...
%
%For more comprehensive comments see ForwardMesh1st.m, which shares many
%functions and features with this class. In future releases, a common
%superclass may be introduced for the two, but for now, there is a lot of
%repetition in the codes of the two classes.
