...
%Estimate_vec.
    ...
    methods
        ...
        function obj = Estimate_Hess(estimates, sizes)
            if nargin == 1
        ...
        function r = plus(o1, o2)
            if isa(o1, 'Estimate_Hess') && isa(o2, 'Estimate_Hess')
        ...
        function r = mtimes(o1, o2)
            if ~isa(o1, 'Estimate_Hess')
                error('Type error!');
            end
            if ~isa(o2, 'Estimate_vec')
                error('Type error!')
            end
            Hess = o1.Matrix();
            grad = o2.Vector();
            tr = Hess*grad;
            r = Estimate_vec(tr, o1.GetSizes());
        end
